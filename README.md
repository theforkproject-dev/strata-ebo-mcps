...
# Optional if Supabase hosted MCP requires resource-bound access tokens.
SUPABASE_OAUTH_RESOURCE=https://mcp.supabase.com/mcp?project_ref=...&read_only=true&features=database,docs
```
